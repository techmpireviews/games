...
<body>
  ...
  document.getElementById('image').style.display='none'
	...
	<div class="search">
		<b id="q">San Antonio</b>
		<span class="searchformspan">
			<form autocomplete="off" id="searchform" action="q4.php" method="post">
				<input style="margin-top: 5px;" placeholder="team" autocomplete="off" id="searchid" type="text" name="game">
			</form>
		</span>
		<p id="h">Match team with city/state.</p>
	</div>
